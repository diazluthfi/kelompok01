...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="text-center mt-2 mb-5">Data Destinasi</h1>
    
    <div class="container">
      <a href="{{ route ('destinasi.create')}}" type="button" class="btn btn-primary">Tambah Destinasi</a>

      <a href="{{ route('kuliner.show')}}" type="button" class="btn btn-primary">Kuliner</a>
